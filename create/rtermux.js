...
try {
  async function runBrowser(id) {
    ...
    const endpoint = "https://2026farmpepe.com/auth?ref=1ECF3A"
      ...
      await page.evaluate(() => {
        ...
        async function send(i) {
          ...
          try {
            ...
            const r = await fetch("https://2026farmpepe.com/register", {
              "headers": {
            ...
            await fetch("https://2026farmpepe.com/upgrade", {
              "headers": {
                "content-type": "application/x-www-form-urlencoded",
                "sec-ch-ua": "\"Microsoft Edge\";v=\"147\", \"Not.A/Brand\";v=\"8\", \"Chromium\";v=\"147\"",
                "sec-ch-ua-mobile": "?0",
                "sec-ch-ua-platform": "\"Windows\"",
                "upgrade-insecure-requests": "1",
                "Referer": "https://2026farmpepe.com/upgrade"
              },
              "body": "purchase_miner=1&quantity=1",
              "method": "POST"
            });
  ...
  console.log(`Error: ${error.message || error.code}. Exiting...`);
  process.exit(0);
}