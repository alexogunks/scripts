...
const JWT = "Bearer eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlU3bU9NMzBNZGJRY3RQMmdoWE4wU0dhTDFIWjNSUWVoZWxkZUNHNF9OaWsifQ.eyJzaWQiOiJjbWZyaDJ3bWkwMDFubDIwZGFvc2YxYzFwIiwiaXNzIjoicHJpdnkuaW8iLCJpYXQiOjE3NTg0MjI3MDMsImF1ZCI6ImNtN2dldjVzNjAwdmJrMmxzajZlMWU5ZzciLCJzdWIiOiJkaWQ6cHJpdnk6Y21lMGx0N25mMDA5MWpsMGJ6b2tybDB4aiIsImV4cCI6MTc1ODQyNjMwM30.GGk8kEKyHiuQmRqPa7Q8SgtPwzrs7IC-Cev6KEp9OOL8kWnZZj3doHdw0uMjwn2i70zdFTjxy9oc3wkbINrawQ"
...
const MAX_SKIPPED_SENDS = 20;
const NO_MESSAGE_TIMEOUT = 5000; // 5s


function restartScript() {
  console.warn("🔄 Restart condition triggered — restarting via runscript.bat...");
  exec("runscript.bat", (err, stdout, stderr) => {
    if (err) {
  ...
  async _onOpen() {
    ...
    this.heartbeatTimer = setInterval(() => {
        ...
        if (Date.now() - this.lastMessageTime > 5000) {
          console.warn(`[${this.actionType}] no messages in 5s → restart`);
          restartScript();   // ⬅ restart when no messages for 5s
          return;
        }      
